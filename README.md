...
The analysis proceeds in four steps:
    ...
    Descriptive Statistics: An overview of Gini, regional unemployment, GDP per capita, and individual-level controls (Age, Education, Income, etc.).

    Empty Model (Null Model): Calculation of the Intraclass Correlation Coefficient (ICC) to determine the variance explained by regional and national levels.

    Multilevel Model (LMM): A comprehensive three-level regression including individual, regional, and national predictors.

    Predicted Values: Calculation and visualization of the predicted marginal effects for the focal independent variables (Gini and Unemployment).
...
The analysis uses the European Social Survey (ESS11) dataset.
    ...
    Independent Variables:
        ...
        Gini Index: Country-level income inequality (2024).

        Regional Unemployment: Percentage of unemployed persons by region (2024).
